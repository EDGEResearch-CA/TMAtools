...
Excel file containing translation and consolidation rules. It must be placed outside TMA folders. Column names should match the template file `biomarker_rules_example.xlsx`. You can create a copy of this file as follows.
...
TMAtools also includes another rules template file called `biomarker_rules_example.xlsx`, which
